...
export default function CotizacionNotFound() {
  return (
    <div style={{ minHeight: "100vh", background: "#1a0d06", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "2rem", textAlign: "center", fontFamily: "Georgia, serif" }}>
      ...
      <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.9rem", maxWidth: 380, lineHeight: 1.7, marginBottom: "2.5rem" }}>
        La cotización de vajilla que buscás no existe o fue eliminada. Si creés que es un error, contactanos por WhatsApp.
      </p>
      <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap", justifyContent: "center" }}>
        <a
          ...
          style={{ padding: "0.6rem 1.6rem", border: "1px solid #C9A84C", color: "#C9A84C", fontSize: "0.75rem", letterSpacing: "0.15em", textDecoration: "none", textTransform: "uppercase" }}
        >
