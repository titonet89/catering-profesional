      ...
      {visible && (
        ...
        >
          ...
          <AnimatePresence>
            {tooltip && (
              ...
              >
                ...
                {/* Flecha */}
                <span className="absolute -right-2 top-1/2 -translate-y-1/2 border-8 border-transparent border-l-white" />
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="w-14 h-14 rounded-full flex items-center justify-center shadow-xl shadow-black/30 transition-shadow hover:shadow-2xl hover:shadow-green-500/20"
